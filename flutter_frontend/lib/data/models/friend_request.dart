...
class FriendRequest {
  ...
  factory FriendRequest.fromMap(Map<String, dynamic> data) => FriendRequest(
    ...
    toId: data["to"]["_id"],
    name: data["from"]["name"],
    avatar: data["from"]["avatar"] == null || data["from"]["avatar"] == "" ? "https://www.zimlive.com/dating/wp-content/themes/gwangi/assets/images/avatars/user-avatar.png" : data["from"]["avatar"] ,
  );
}