  ...
  Widget build(BuildContext context) {
              ...
              child: Row(
                children: [
                  ...
                  Flexible(
                    child: Text(
                      RegExp(r"(?<=files\/)(.*)(?=.(\\?alt=))")
                          .firstMatch(Uri.decodeFull(content))!
                          .group(0)!,
                      style: TextStyle(
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          margin:
              EdgeInsets.only(left: 10, top: (isRoom && !isSender) ? 2 : 10),
          padding: EdgeInsets.symmetric(
            vertical: 10,
            horizontal: 15,
          ),
          decoration: BoxDecoration(
            color: isDeleted
                ? Palette.americanSilver
                : (isSender ? Palette.blue : Colors.white),
            borderRadius: isSender
                ? BorderRadius.only(
                    topLeft: Radius.circular(30),
                    topRight: Radius.circular(30),
