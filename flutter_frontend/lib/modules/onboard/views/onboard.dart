...
import 'package:flutter_frontend/modules/onboard/controllers/onboard_controller.dart';
import 'package:flutter_frontend/core/constants/font_family.dart';
import 'package:flutter_frontend/core/theme/palette.dart';
import 'package:flutter_frontend/modules/onboard/widgets/page_item.dart';
              ...
              Expanded(
                child: PageView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return PageItem(
                      imagePath: onboardController.pageData[index]
                          ['imagePath']!,
              ...
              Obx(
                () => Row(
                  children: [
                    Opacity(
                      opacity:
                          onboardController.currentIndex.value == 0 ? 0 : 1,
                      child: GestureDetector(
                        onTap: onboardController.currentIndex.value == 0
                            ? () {}
                    ...
                    GestureDetector(
                      onTap: onboardController.currentIndex.value != 2
                          ? onboardController.onNextPage
